...
library(pheatmap)
########Haplotype plot############
#Central refers to Alcippe davidi,east refers to Alcippe hueti, west refers to Alcippe fratercula

#######
output=vcf2geno("/mnt/disk1/zhangshuai/hkqm/af_shifts/hd_intro.vcf",output.file ="/mnt/disk1/zhangshuai/hkqm/af_shifts/hd_intro.geno" ) #only adaptive introgressed SNPs were included in the VCF file.  
...
#Set davidi major alleles as the reference and code them as ‘0’.
...
#Extract SNPs fixed for alternative alleles in the parental species
...
pheatmap(num_matrix[1:53,a],fontsize=2, cluster_rows = F, cluster_cols = F,   gaps_row = c(22,40),gaps_col =c(3,65,145,160,372,476,500,505,508,600,525,530,540,545,585,632,698,699,702), #Split by scaffold
