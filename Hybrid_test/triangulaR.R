...
system("
plink2 --vcf /mnt/disk1/gghybrid/vcf71.8.60.maf.0.05.ld.nomissing.vcf   --aec --keep ./e_c.id --export vcf --out ./hueti_davidi")

data_hueti_davidi <- read.vcfR("/mnt/disk1/gghybrid/hueti_davidi.vcf", verbose = F)
...
#pdf("/mnt/disk1/gghybrid/output.pdf", width = 7, height = 5) 
