...
#3. Train the classifier. Run multiple times to obtain stable results.
...
#5. Use classifier to produce classifications on the real data set. To obtain stable results, combine the outputs of multiple classifiers in step#3.
